...
typedef struct BIT32_REG_DEF {
   Uint16  LSW;  //LSW和MSW也是表示位域中的最低有效字/最高有效字
   Uint16  MSW;
}BIT32_REG;
...
#define STATUS_BEFORE_RUN_DETECT 8
#define STATUS_RS_TUNE          9
#define STATUS_FLYING_START	10//转速跟踪启动阶段
...
//#define  SYNC_SVC_TEST_CODE
#define  SOFTSERIES             2
#define  MD500SOFT              1 
#define  MD380SOFT              2
#define  AIRCOMPRESSOR          0
...
#define  C_DOUBLE_ACR_MAX_FC    40      //能够采用双电流环的最高载波频率
/************************************************************
