...
{
    {DISPLAY_B,     DISPLAY_A,      DISPLAY_5,      DISPLAY_E},     // base
    {DISPLAY_U,     DISPLAY_5,      DISPLAY_E,      DISPLAY_r},     // user
    {DISPLAY_LINE,  DISPLAY_C,      DISPLAY_LINE,      DISPLAY_LINE},   // --C--
};
...
//Uint16 displayBuffer[6] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff};   // NULL
Uint16 displayBuffer[DISPLAY_8LED_NUM + 1] = {0xbf, 0x89, 0xbf, 0xc6, 0xbf, 0x80};  // -H-C-, LED全亮
//Uint16 displayBuffer[6] = {0x80, 0x80, 0x80, 0x80, 0x80, 0x80};   // 88888
//Uint16 displayBuffer[6] = {0xbf, 0x8b, 0xa3, 0xc7, 0xa1, 0xef};   // -hoLd
//Uint16 displayBuffer[6] = {0x80, 0x8b, 0xa3, 0xc7, 0xa1, 0xef};   // 8hoLd
