...
#define INIT_EXCEPT_SINGLE_4    GetCodeIndex(funcCode.code.softVersion) // tempsoftversion)     // 临时软件版本号
...
#define INIT_EXCEPT_SINGLE_12   GetCodeIndex(funcCode.code.speedFdbDir)         // 速度反馈方向

#define INIT_EXCEPT_SINGLE_13    GetCodeIndex(funcCode.code.softVersion)    // 性能软件版本号
#define INIT_EXCEPT_SINGLE_14    GetCodeIndex(funcCode.code.softVersion)// 性能软件版本号
