...
#define ERROR_P2P_SLAVE                 55         // 点对点从机故障
#define ERROR_BRAEK_SHORT               60      // 60-- 制动电阻短路
#if DEBUG_MD500_SEARIS||DEBUG_MD290_SEARIS
#define ERROR_BRAEK_IGBT_OVERLOAD       61      // 61制动管过载
#define ERROR_BRAEK_IGBT_SHORT          62      // 62制动管直通
#else
#define ERROR_BRAKE_R_DETECT			61      // 61制动电阻连续开通超时	
#define ERROR_BRAKE_RSVD			    62      // 62预留	
#endif

#define ERROR_SVC_RSVD                      63      // 63SVC失速故障

//增加防报过载方案 modify by libo-2103 2014-12-24 9:50:00
#define ERROR_COEFF                     64      // 反电动势异常故障
...
#define COMM_ERROR_CANLINK_ADDR 20 // 地址冲突
#define COMM_ERROR_P2P_SLAVE_OUT   21   // 负荷从机掉线
#define COMM_ERROR_P2P_SLAVE_ERROR 22   // 从机故障 
#define COMM_ERROR_CANOPEN    3
#define COMM_ERROR_PROFIBUS   4
#define COMM_ERROR_P2P        5
#define COMM_ERROR_PLC        6
#define COMM_ERROR_EXTENDCAR  7    // 扩展卡故障
