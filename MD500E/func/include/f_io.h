...
#define DI_FUNC_NUMBER              63      // DI的功能选择数量
#elif 1
...
struct DI_FUNC2_BITS
{
    ...
    Uint16 motorSnDi:1;             // 41  : 电机选择端子。选择了该端子，电机选择功能码无效
    Uint16 rsvd1:1;                 // 42,保留
    ...
    Uint16 twolineOrthreeline:1;    // 51: 两线式/三线式切换
    Uint16 forbidRev:1;             // 52: 禁止反转
///门机DI端子
    Uint16 doorOpenIn:1;		    // 53: 开门命令
    Uint16 doorCloseIn:1;           // 54: 关门命令
    Uint16 drOpLimitInNO:1;		    // 55: 开门到位信号常开输入
    Uint16 drClLimitInNO:1;		    // 56: 关门到位信号常开输入
    Uint16 drOpLimitInNC:1;		    // 57: 开门到位信号常闭输入
    Uint16 drClLimitInNC:1;		    // 58: 关门到位信号常闭输入
    Uint16 drOpChangeInNO:1;	    // 59: 开门换速点信号常开输入
    Uint16 drClChangeInNO:1;	    // 60: 关门换速点信号常开输入
    Uint16 drOpChangeInNC:1;	    // 61: 开门换速点信号常闭输入
    Uint16 drClChangeInNC:1;	    // 62: 关门换速点信号常闭输入
...
#define DO_FUNC_NUMBER               44  // DO的功能选择数量
#else   
...
struct DO_FUNC2_BITS
{
    ...
    Uint16 errorOnNoUV:1;             // 32+9: 故障输出(欠压不输出)
	Uint16 addSpeedStatus:1;	      // 32+10
	Uint16 decSpeedStatus:1;		  // 32+11
    Uint16 rsvd0:4;                   // 
...
#define AO_FMP_FUNC_OUT_FACT_TORQUE_DIR 17 //实际输出转矩(带正负)
//======================================================================
