...
#define			SCI_TX_INT_SPEEDUP				0			// 处于电子标签数据命令时返回数据不为4的倍数，不加速使能
#else
#define			SCI_TX_INT_SPEEDUP				1			// 不处于电子标签命令使能加速 
#endif
#if DSP_2803X
...
// APP区功能
#define			FC_CODE_APP_EN					1			// APP区功能使能
#if	FC_CODE_APP_EN
#if DEBUG_MD500_SEARIS||DEBUG_MD290_SEARIS||DEBUG_MD380E_SEARIS//by add YZ 1990
#define			FC_CODE_BOOTPIN_EN				0x01		// 烧录工装引出BOOT使能脚
#define			OSC_CON_FRAME_HEAD_APP			0x01		// 命令帧帧头
#define			FC_APP_READ_WRITE		    0x45		// APP区功能--读 
#define			FC_APP_STATE					0x0004		// APP区功能--查询运行状态
#define			FC_APP_RETURN_BOOT				0x0005		// APP区功能--跳转到BOOT区
#define			FC_APP_LABEL					0x0010		// APP区功能--获取APP区电子标签
#else
#define			FC_CODE_BOOTPIN_EN				0x01		// 烧录工装引出BOOT使能脚
#define			OSC_CON_FRAME_HEAD_APP			0x01		// 命令帧帧头
#define			FC_APP_WRITE					0x43		// APP区功能--写
#define			FC_APP_READ						0x44		// APP区功能--读
#define			FC_APP_RETURN_BOOT				0x022f		// APP区功能--跳转到BOOT区
#define			FC_APP_POPEDOM					0x012f		// APP区功能--获取烧录权限
#define			FC_APP_STATE					0x002f		// APP区功能--查询运行状态
#define			FC_APP_LABEL					0x042f		// APP区功能--获取APP区电子标签
#endif
#endif

/************************添加MD380键盘函数**********************************/
#define			FC_KEY_CONTROL_EN			1			// 串行键盘功能禁能，“1”使能，“0”关闭
#define			FC_VERSION_DATA				0x51		// 读机型、版本号操作
#define			FC_LOWER_DATA				0x52		// 读内部下限值操作
#define			FC_UPPER_DATA				0x53		// 写内部上限值操作
#define			FC_INIT_DATA				0x54		// 读内部出厂值操作
#define			FC_ATTRIBUTE_DATA			0x55		// 读内部属性操作
#define			FC_ATTRIBUTE_UDATA			0x56		// 读U组内部属性操作
#define         FF_PASSWORD                 3410        //通信控制FF组参数
/***********************************************************************************/
// 后台控制结构
