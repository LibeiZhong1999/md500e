...
#define FUNC_TO_MOTOR_2MS_DATA_NUM      75+33+11+1+31+9  // 功能==>性能的参数个数，2ms
//#define FUNC_TO_MOTOR_2MS_DATA_NUM      75+33+11    // 功能==>性能的参数个数，2ms
//#define FUNC_TO_MOTOR_2MS_DATA_NUM      75        // 功能==>性能的参数个数，2ms
#define FUNC_TO_CORE_DEBUG_DATA_NUM     30      // 调试使用，func2motor
extern int16 gSendToMotor2MsDataBuff[];         // 功能==>性能的参数，2ms

// 最后FUNC_TO_CORE_DEBUG_DATA_NUM个参数，CF组功能码，每拍都会传递给性能，性能调试使用

#define MOTOR_TO_Func_2MS_DATA_NUM      34+2      // 性能==>功能的参数个数，2ms
